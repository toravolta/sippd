                ...
                <div class="card-body">
                    <div class="row d-flex align-items-stretch">
                        <div class="col-lg-12 mx-auto" style="overflow-x: scroll;">
                            @can('user-create')
                            <div class="mb-3">
                                <a class="btn btn-success text-sm float-left" href="{{route('users.create')}}" role="button"><i class="fas fa-plus"></i> Add New User</a>
                            </div>
                            @endcan
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"><i class="fa fa-trash"></i> &nbsp; Delete User</h5>
...
$(document).ready(function () {
    var canEdit = <?php echo auth()->user()->can('user-edit') ? 1 : 0 ?>;
    var canDelete = <?php echo auth()->user()->can('user-delete') ? 1 : 0; ?>;
        ...
        "columns": [{
            ...
            },
            {
                mRender: function (data, type, row) {
                    var button = (canEdit ? '<a class="btn btn-warning btn-sm mr-1" data-toggle="tooltip" data-placement="top" title="Edit" href="{{ url("users")}}/' + row.id + '/edit"><i class="far fa-edit"></i></a>' : '') +
