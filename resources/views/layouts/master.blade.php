...
<body class="accent-olive">
    ...
    <div id="app">
        <div class="wrapper">
            ...
            <footer class="main-footer">
                ...
                <strong>Copyright &copy; 2021 <a href="#">VSI</a>.</strong> All rights
                reserved.
            </footer>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        $('ul.nav-treeview a').filter(function() {
            return url.includes(this.pathname);
        }).parentsUntil(".nav-sidebar > .nav-treeview").addClass('menu-open').prev('span').addClass('active text-white');
    </script>
